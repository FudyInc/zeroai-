...
class Concierge(BaseAgent):
    ...
    def _mock_result(self, task: TaskPayload) -> Tuple[Dict[str, Any], str, Optional[str]]:
        ...
        if _has(msg, "robot", "humano", "persona", "eres ia", "eres un bot", "es un bot", "automático"):
            ...
            intent = "pricing"
        elif _has(msg, "qué hacen", "que hacen", "cómo funciona", "como funciona", "servicio", "qué es", "que es"):
            ...
            intent = "explain"
        elif _has(msg, "reunión", "reunion", "agendar", "llamada", "cuándo", "cuando", "hora", "agenda", "meeting"):
            ...
            intent = "meeting"
        elif _has(msg, "no", "no me interesa", "stop", "baja", "no gracias"):
